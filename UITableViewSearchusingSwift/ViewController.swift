...
//  UITableViewSearchusingSwift
//
//  Created by Hardik Trivedi on 14/10/2015.
//  Copyright (c) 2015 iHartDevelopers. All rights reserved.
//

import UIKit

class ViewController: UITableViewController, UISearchDisplayDelegate, UISearchBarDelegate
{
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        return cellCountry as! UITableViewCell
    }
